...
begin
 ...
 booking := public.book_viewing(slot,'Test','test@example.invalid',null,'U1','sql-test');
 ...
 begin
  perform public.book_viewing(slot,'Other','other@example.invalid',null,'U1','sql-test-other');
